...
class ConventionType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('tauxdirecteur')
            ->add('idbanque', 'entity', array('empty_value'=>'Sélectionner une Banque','class'=> 'EmpruntBundle:Banque','property' => 'nom','required' => false
            ))
            ->add('idbesoin', 'entity', array('empty_value'=>'Sélectionner un Besoin','class'=> 'EmpruntBundle:Besoin','property' => 'libelle','required' => false
            ))   
        ;
        $builder->add('tirages', 'collection', array(
                'required' => true,
                'allow_add' => true,
                'prototype' => true,
                'type' => new AddTirageType(),
            ));        
        
        $builder->add('commisions', 'collection', array(
                'required' => true,
                'allow_add' => true,
                'prototype' => true,

...
this.oInstance=null;this.oFeatures={bPaginate:true,bLengthChange:true,bFilter:true,bSort:true,bInfo:true,bAutoWidth:true,bProcessing:false,bSortClasses:true,bStateSave:false,bServerSide:false,bDeferRender:false};this.oScroll={sX:"",sXInner:"",sY:"",bCollapse:false,bInfinite:false,iLoadGap:100,iBarWidth:0,bAutoCss:true};this.aanFeatures=[];this.oLanguage={sProcessing:"Processing...",sLengthMenu:"Voir _MENU_ enregistrement",sZeroRecords:"No matching records found",sEmptyTable:"No data available in table",
sLoadingRecords:"Loading...",sInfo:"Affichage de _START_ à _END_ de _TOTAL_ enregistrement",sInfoEmpty:"Affichage de 0 à 0 de 0 enregistrement",sInfoFiltered:"(filtered from _MAX_ total enregistrement)",sInfoPostFix:"",sInfoThousands:",",sSearch:"Chercher:",sUrl:"",oPaginate:{sFirst:"Début",sPrevious:"Précédent",sNext:"Suivant",sLast:"Fin"},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=[];this.aoColumns=[];this.aoHeader=[];this.aoFooter=[];this.iNextId=0;this.asDataSearch=[];this.oPreviousSearch={sSearch:"",
